...
public class LoginService {
    ...
    userData.put("admin", new LoginUser("admin", "123", "Indonesia"));
    userData.put("faris", new LoginUser("faris", "123", "Amerika"));
    }
    ...
    userData.put(username, new LoginUser(username, password, country));
    return true;
}
